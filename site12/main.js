const votes = [
    ...
    { topic: "Best chair?", options: ["Bean bag", "Rocking chair"] },
    { topic: "Most underrated?", options: ["Leftovers", "Napkins"] },
    { topic: "Cooler accessory?", options: ["Cape", "Eyepatch"] },
    { topic: "Most chaotic?", options: ["Squirrel on espresso", "Goose with a grudge"] },
    { topic: "Better pizza topping?", options: ["Pineapple", "Mushrooms"] },
    { topic: "Best smell?", options: ["Freshly baked bread", "New book"] },
    { topic: "More loyal?", options: ["Boomerang", "Yo-yo"] },
    { topic: "Weirder job?", options: ["Professional cuddler", "Pet food taster"] },
    { topic: "More iconic duo?", options: ["Peanut butter & jelly", "Mac & cheese"] },
    { topic: "More confusing sound?", options: ["Yanny", "Laurel"] },
    { topic: "Stronger emotion?", options: ["Cringe", "Secondhand embarrassment"] },
    { topic: "Best random dance?", options: ["Floss", "Chicken dance"] },
    { topic: "More dangerous?", options: ["Lego on the floor", "Unlabeled USB stick"] },
    { topic: "Tougher opponent?", options: ["Grandma in Mario Kart", "Baby with a nerf gun"] },
    { topic: "Most rebellious?", options: ["Unsharpened pencil", "Out-of-tune kazoo"] },
    { topic: "Better childhood game?", options: ["Hide and seek", "Tag"] },
    { topic: "Most frustrating?", options: ["Tangling earphones", "Losing the TV remote"] },
    { topic: "Best background noise?", options: ["Rainfall", "Crackling fire"] },
    { topic: "Cooler retro tech?", options: ["Walkman", "Game Boy"] },
    { topic: "More intense sport?", options: ["Chessboxing", "Extreme ironing"] }
];
