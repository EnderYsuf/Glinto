...
const descs = {
    "Cucumber": "Cool and composed, you're always the calm in the storm.",
    "Tomato": "Juicy and fun, you’re the life of the garden party.",
    "Carrot": "Energetic and bright, you’re a natural motivator.",
    "Potato": "Reliable and comforting, everyone loves having you around.",
    "Corn": "Friendly and sunny, you bring warmth wherever you go.",
    "Garlic": "Strong and bold, you're not afraid to stand out.",
    "Lettuce": "Laid-back and fresh, you bring balance to any plate.",
    "Pumpkin": "Warm and festive, you're always a seasonal favorite.",
    "Radish": "Zesty and sharp, you add spice to life."
};
...
function showResult() {
    ...
    desc.textContent = descs[chosenVegetable];
    desc.style.marginTop = "10px";
    desc.style.fontSize = "18px";
    desc.style.color = "#fff";
    document.getElementById("result").after(desc);
}
